...
INSERT INTO agregaty.waluty_w_latach(id_waluty, rok, kurs, proc_zmiana)
	(SELECT id_waluty,rok,round(AVG(kurs),5) as kurs,ROUND(AVG(proc_zmiana),5) as proc_zmiana
